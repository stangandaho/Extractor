from qgis.PyQt.QtWidgets import (QDialog, QVBoxLayout, QLabel, QComboBox, QPushButton, 
                                 QTableWidget, QTableWidgetItem, QLineEdit, QHBoxLayout, QFileDialog)
...
icon_file = os.path.join(os.path.dirname(__file__), 'icons', 'icon.svg')
...
class Delim(QDialog):
    def __init__(self, file_path):
        ...
        self.delimiter_label =  QLabel("Delimiter/Separator:")#ok
    ...
    def populate_columns(self):
        ...
        df = pd.read_csv(filepath_or_buffer = self.file_path, sep = delimiter)
