...
SOURCES = \
	__init__.py \
	Extractor.py Extractor_dialog.py

PLUGINNAME = Extractor

PY_FILES = \
	__init__.py \
	Extractor.py Extractor_dialog.py

UI_FILES = Extractor_dialog_base.ui
...
QGISDIR=C:\Users\ganda\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
